...
public enum ErrorType {
    ...
    DUPLICATE_ENTRY("CAR-ERR-0002", "Unable to create the car since it already exists", 409),
    ...
    VALIDATION_ERROR("CAR-ERR-0006", "There is a data validation that indicates the payload is not filled properly", 400),
    INTERNAL_SERVER_ERROR("CAR-ERR-0007", "An unexpected error occurred while processing the request", 500);
